# RATP Platform — AWS Infrastructure
...
│
├── helm/                            # Helm Charts
│   └── ratp-service/           # Generic chart (shared by all services)
│
...
|-------------|---------------|-----|---------|
| dev | `ratp-dev` | db.t4g.micro, single-AZ (free tier) | Development & testing |
| prod | `ratp-prod` | db.t4g.micro, single-AZ (free tier) | Production |
